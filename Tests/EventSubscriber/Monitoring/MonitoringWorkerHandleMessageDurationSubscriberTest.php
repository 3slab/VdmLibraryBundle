...
use Vdm\Bundle\LibraryBundle\EventSubscriber\Monitoring\MonitoringWorkerHandleMessageDurationSubscriber;
...
class MonitoringWorkerHandleMessageDurationSubscriberTest extends TestCase
{
    protected $envelope;
    ...
    public function setUp(): void
    {
        ...
        $this->storage->expects($this->once())
            ...
            ->will($this->returnCallback(function($key, $value) {
                $this->assertEquals(Monitoring::DURATION_STAT, $key);
    ...
    public function testWorkerMessageHandledSendMetric()
    {
        ...
        $subscriber = new MonitoringWorkerHandleMessageDurationSubscriber($this->storage);
